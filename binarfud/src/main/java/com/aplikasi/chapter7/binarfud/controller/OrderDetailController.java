...
public class OrderDetailController {
    ...
    @PostMapping(value ={"/addOrderDetailTransactional","/addOrderDetailTransactional/"})
    public void addOrderDetailTransactional(@RequestBody OrderDetail orderDetail) {
        try {
            orderDetailService.addOrderDetailTransactional(orderDetail);
        } catch (Exception e) {
            throw new RuntimeException("INTERNAL SERVER ERROR 500 :" + e.getMessage());
        }
    }
}